# SecureGitTrust (SKT): Enhanced S/MIME Commit Signing with Device Authentication
>  S/MIME signing for Git commits in an environment where devices are managed by MDM and access control is managed by Okta. It ensures that only compliant devices can make signed commits to Git repositories.
